...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _240: o => o === undefined,
      _259: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _263: (l, r) => l === r,
      _264: o => o,
      _265: o => o,
      _266: o => o,
      ...
      _273: l => arrayFromDartList(Int8Array, l),
      _274: l => arrayFromDartList(Uint8Array, l),
      _275: l => arrayFromDartList(Uint8ClampedArray, l),
      _276: l => arrayFromDartList(Int16Array, l),
      _277: l => arrayFromDartList(Uint16Array, l),
      _278: l => arrayFromDartList(Int32Array, l),
      _279: l => arrayFromDartList(Uint32Array, l),
      _280: l => arrayFromDartList(Float32Array, l),
      _281: l => arrayFromDartList(Float64Array, l),
      _283: (data, length) => {
      ...
      _284: l => arrayFromDartList(Array, l),
      _287: l => new Array(l),
      _291: (o, p) => o[p],
      _295: o => String(o),
      _297: o => {
      ...
      _326: x0 => x0.random(),
      _327: x0 => x0.random(),
      _331: () => globalThis.Math,
      _333: Function.prototype.call.bind(Number.prototype.toString),
      _7107: (x0,x1) => x0.textContent = x1,
      _7112: () => globalThis.document,
